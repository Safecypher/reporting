...
number: 1
name: Visual confirmation of the duplicate-date hint's tone/copy (WR-02/WR-09)
expected: |
  Trigger an exact-date collision in both create and edit mode; observe the inline preview and
  the submit-time banner. `PRICING_DUPLICATE_EFFECTIVE_FROM` copy renders consistently, in a
  neutral (non-alarming) tone, in both places and both modes.
